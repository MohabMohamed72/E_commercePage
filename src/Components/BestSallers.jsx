...
const BestSallers = () => {
    ...
    useEffect(()=>{
        const data = products.filter((el)=>(el?.bestseller))
        setProduct(data)
    },[])
  ...
  return (
   <div className='mt-20'>
    <div className='flex justify-center'>
        <h1 className='m-0 text-[35px] font-[500]'><span className='text-gray-600 font-normal'>BEST </span> SELLERS</h1>
        <p className='font-[900] text-[35px] translate-y-[-18px] ml-1'>_____</p>
    </div>
